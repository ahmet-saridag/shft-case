...
export default function LoginComponent({translateData}:any) {
  ...
  const { setUserData, isSignUp } = useGeneralStore(
    (state) => state,
  )
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                {!authStatus ? (translateData?.createAccount) : translateData?.signTitle}
              </h1>
              <form
                onSubmit={handleForm}
              ...
              >
                     ...
                     isFetching ? (
                      <div role="status">
                       ...
                       <span className="sr-only">Loading...</span>
                        ...
                        ) : !authStatus ? translateData?.createAccount : translateData?.login
                  }
                </button>
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  >
                    {!authStatus ? translateData?.loginHere : translateData?.signUp}
                  </a>
                </p>
              </form>
            </div>
