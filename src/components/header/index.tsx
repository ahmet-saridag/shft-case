...
function Header({translateData}:any) {
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="md:flex hidden items-center justify-center  md:order-2">
          ...
          >
            {isLoggin ? (translateData.jobList ? translateData.jobList  : "Job List") : (translateData.login ? translateData.login  : "Login") }
          </button>
          <button
          ...
          >
            {isLoggin ? ((translateData.logout ? translateData.logout  : "Logout")) : (translateData.signIn ? translateData.signIn  : "Sign up")}
          </button>
          ...
          <div className="absolute top-16 w-80 h-10">
          {
            modalToggle && (
              <div
              className="absolute top-0 right-0 z-50 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
            >
              <ul className="py-2 font-medium" >
                ...
                <li className="cursor-pointer" onClick={() => changeLanguage("tr")}>
                  <a
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                  >
                    <div className="inline-flex items-center">🇹🇷  {translateData.turkish ? translateData.turkish :  "Turkish"}
                    </div>
                  </a>
                </li>
              </ul>
      ...
      {modalToggle && (
        ...
        <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
          <li>
            <a href="#" className="block py-2 px-3 text-white bg-blue-700 rounded dark:bg-blue-600" aria-current="page">Login</a>
          </li>
          <li>
            <a href="#" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Sign in</a>
          </li>
          <li>
