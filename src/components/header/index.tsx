...
function Header({ translateData, params }: any) {
  ...
  const detailController = () => {
    if (isLoggin) {
      router.push("/" + params.locale + "/jobs");
    } else {
      setIsSignUp(true);
      router.push("/" + params.locale + "/login");
    }
  ...
  const changeLanguage = (lang: any): any => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="md:flex relative hidden items-center justify-center  md:order-2">
          <button
          ...
          <div
            className={
              isLoggin ? "hidden md:flex items-center gap-4 ml-2" : "hidden"
            }
          >
            <img
            ...
            <div className="font-medium dark:text-white">
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400">
                {translateData.date ? translateData.date : "Joined in May 2024"}
              </div>
            </div>
          </div>
          {currentLanguage === "en" ? (
            ...
            >
              ...
              {translateData.english ? translateData.english : "English (US)"}
            </button>
          ) : (
            <button
              type="button"
            ...
            >
              🇹🇷
              {translateData.turkish ? translateData.turkish : "Turkish"}
            </button>
          )}
          <div className="md:flex hidden md:absolute top-14 w-full h-10">
            {modalToggle && (
              <div className="md:absolute top-0 md:right-0 z-50 text-base list-none bg-white md:divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
      ...
      {mobileNavbar && (
        <div className="md:hidden w-full flex">
          <ul className="w-1/2 mx-auto flex flex-col font-medium mt-4 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
            <button
              onClick={detailController}
              type="button"
              className="text-white w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-xs px-5 py-2.5 text-center"
            >
              {isLoggin
                ? translateData.jobList
                  ? translateData.jobList
            ...
            <button
              onClick={loginController}
              type="button"
              className="text-white w-full mt-2 bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-xs px-5 py-2.5 text-center"
            >
              {isLoggin
                ? translateData.logout
                  ? translateData.logout
          ...
          <ul className="py-2 font-medium">
            ...
            <li className="cursor-pointer" onClick={() => changeLanguage("tr")}>
              <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                <div className="inline-flex items-center">
                  🇹🇷 {translateData.turkish ? translateData.turkish : "Turkish"}
                </div>
